    ...
    <div className="rounded-box bg-base-200 p-4">
      <div className="flex items-center gap-4">
        <div className="space-y-2">
          ...
          <div className="flex items-baseline gap-2" data-testid="total-breaks">
            <span className="badge badge-accent">{stats.totalBreaks}</span>
            <span>Breaks</span>
          </div>
          {stats.totalWorkTime > 0 && (
            <div className="flex items-baseline gap-2" data-testid="total-time">
